...
export const OCRgpt = () => {
  ...
  return (
    <div className="group hover:shadow-lg flex flex-col items-center gap-4 p-5 border rounded-2xl shadow-md w-full max-w-[310px] md:max-w-lg mx-auto transition-all">
