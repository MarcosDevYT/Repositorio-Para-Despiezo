...
export const OCRVision = () => {
  const [oemNumber, setOemNumber] = useState<string | null>(null);
  ...
  return (
    <Card className="max-w-lg group hover:shadow-lg transition-all duration-300 bg-gradient-to-br from-blue-500/5 to-blue-500/10 border border-blue-500/20 gap-2">
