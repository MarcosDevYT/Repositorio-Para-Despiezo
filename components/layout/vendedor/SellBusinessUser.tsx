...
import { EditBusinessBanner } from "./EditBusinessBanner";
import { SellVendorAnalytics } from "./SellVendorAnalytics";
...
export const SellBusinessUser = ({ session }: Props) => {
  ...
  return (
    <>
      <div className="w-full bg-white border-gray-200 shadow-lg rounded-2xl overflow-clip">
        {/* Banner del negocio editable */}
        {user.pro && (
          <EditBusinessBanner
        ...
        <Card className="lg:flex-row w-full p-0 bg-white border-0 border-t border-gray-200 shadow-none rounded-none gap-2">
