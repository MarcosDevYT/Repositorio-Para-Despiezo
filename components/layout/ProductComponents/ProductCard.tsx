...
export const ProductCard = ({
  ...
  return (
    <Card className="group w-full max-w-80 rounded-2xl overflow-hidden bg-white border border-border/50 shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:-translate-y-1 flex flex-col">
      {/* Imagen + acciones */}
      <CardHeader className="relative p-0 flex-shrink-0">
        ...
        {/* Imagen del producto */}
        <div
          className="relative h-44 bg-gradient-to-br from-muted/30 to-muted/10 cursor-pointer overflow-hidden"
